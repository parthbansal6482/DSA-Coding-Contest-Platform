...
export function TeamsSection() {
  const [teams, setTeams] = useState<Team[]>([
    ...
    },
    {
      ...
      status: 'pending',
      registrationDate: '2026-01-20T14:30:00',
    },
    {
      id: '3',
    ...
    },
    {
      ...
      status: 'approved',
      registrationDate: '2026-01-18T16:45:00',
    },
    {
      id: '5',
      teamName: 'Runtime Rebels',
      members: [
        { name: 'Liam Harris', email: 'liam@example.com' },
      ],
      status: 'rejected',
      registrationDate: '2026-01-19T11:20:00',
    },
  ]);
