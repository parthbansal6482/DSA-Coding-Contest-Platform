...
const seedData = async () => {
    try {
        ...
        if (existingTeams === 0) {
            const teamsWithApproval = sampleTeams.map(team => {
            ...
            await Team.insertMany(teamsWithApproval);
            console.log(`✅ Created ${sampleTeams.length} sample teams\n`);
        } else {
            console.log(`ℹ️  ${existingTeams} teams already exist\n`);
        }
        ...
        console.log('   • Email: admin@contest.com');
        console.log('   • Password: admin123\n');
        console.log('   Team Login (any approved team):');
        console.log('   • Team Name: CodeNinjas (or BinaryBeasts, AlgoMasters)');
