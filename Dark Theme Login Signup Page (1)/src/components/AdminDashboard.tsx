...
function OverviewSection() {
  const stats = [
    { label: 'Total Teams', value: '24', color: 'bg-blue-500' },
    { label: 'Pending Approvals', value: '5', color: 'bg-yellow-500' },
    { label: 'Total Questions', value: '48', color: 'bg-green-500' },
    { label: 'Active Rounds', value: '3', color: 'bg-purple-500' },
  ];
