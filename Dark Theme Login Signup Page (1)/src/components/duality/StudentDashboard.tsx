...
import { Code2, CheckCircle2, Clock, Trophy, User, LogOut, TrendingUp, Target, BarChart3, FileText, StickyNote } from 'lucide-react';
...
export function StudentDashboard({ 
  ...
  const [activeTab, setActiveTab] = useState<'problems' | 'profile' | 'history' | 'notes'>('problems');
